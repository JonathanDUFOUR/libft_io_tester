...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/02 14:33:15 by jodufour          #+#    #+#             */
/*   Updated: 2022/05/02 14:55:20 by jodufour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	test_one(int const i, int const *fd, int *const ret)
{
	...
	if (ft_putdouble_fd(g_test[i].nb, g_test[i].prec, fd[1]) == -1)
		return (*ret = FT_PUTDOUBLE_FD_ERR);
